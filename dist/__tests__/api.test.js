    ...
    describe("GET /api/events/:event_id", () => {
        test("returns a 200 response status with correct data properties", () => {
            return (0, supertest_1.default)(app_1.default)
                ...
                expect(event.image).toBe("https://res.cloudinary.com/dufw9aqhs/image/upload/v1743083955/tech-conference-25_f05doj.png");
    ...
    describe("POST /api/events/:created_by", () => {
        test("returns 201 status code and an object with event added", () => {
            const body = {
                ...
                image: "https://res.cloudinary.com/dufw9aqhs/image/upload/v1743084225/cloud_bmbgcc.jpg",
            };
            return (0, supertest_1.default)(app_1.default)
                .post("/api/events/1")
                .send(body)
                ...
                expect(event.image).toBe("https://res.cloudinary.com/dufw9aqhs/image/upload/v1743084225/cloud_bmbgcc.jpg");
                expect(new Date(event.start_time)).toBeInstanceOf(Date);
                expect(new Date(event.end_time)).toBeInstanceOf(Date);
            });
        });
    ...
    describe("PATCH /api/events", () => {
        test("returns event object updated with passed event body information", () => {
            const body = {
                ...
                start_time: 1755277200000,
                end_time: 1755306000000,
                image: "https://res.cloudinary.com/dufw9aqhs/image/upload/v1743083955/tech-conference-25_f05doj.png",
            };
            return (0, supertest_1.default)(app_1.default)
                .patch("/api/events")
                .send(body)
